...
//! ~/.local/share/atlas-api/vpn.json so they survive restarts.
...
fn state_path() -> String {
    ...
    format!("{home}/.local/share/atlas-api/vpn.json")
}
...
/// on an admin user — the API server reads `ATLAS_ADGUARD_AUTH=user:pass` from
